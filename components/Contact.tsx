      ...
      <footer className="site-footer">
        <div className="footer-inner">
          ...
          <div className="footer-socials">
            ...
            <a href="https://www.linkedin.com/in/renz-carljansen-sarucam" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="LinkedIn">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href={`mailto:${contactEmail}`} className="footer-social-link" aria-label="Email">
